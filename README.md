...
公開テンプレート・CSSを用いたローカル検証画面です。表示内容は架空データです。[狭い画面のダーク表示](docs/images/presets-mobile-dark.png)も確認しています。
...
3. **Show more** で続きを取得します。該当ゼロのページは読み飛ばし、結果が見つかった時点または10ページで停止します。
4. **Cancel** で中止し、再度 **Show more** で未取得のページから再開できます。
